    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="content-title"><a href="/choose_items_of_invoice/{{$invoice->id}}" class=" mt-1 tx-13 mr-2 mb-0">/ إضافة  فاتورة</a></span>
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ استكمال بيانات الفاتورة</span>
            </div>
        </div>
                                ...
                                <div class="panel-body tabs-menu-body main-content-body-right border">
                                        ...
                                        <table class="table table-hover mb-0 text-md-nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   <td>
													<a href="/choose_items_of_invoice/{{$invoice->id}}" class="btn btn-sm btn-info">
                                  ...
                                  <div class="d-flex justify-content-center my-3">
                                   ...
                                   <div class="tab-pane" id="tab5">
                                          {{-- 1 --}}
                             <form action="{{ route('store_invoice_data', $invoice->id) }}" method="post" 
                                            autocomplete="off">
                                           @csrf
                                   <div class="row">
                                    <div class="col">
                                        @php
                                        $ref = substr($invoice->reference_number, 3);
                                    @endphp
                                        <label for="inputName" class="control-label">رقم البيع[INV/INVOICE]</label>
                                  ...
                                  <br>
                                   ...
                                   <div class="row">
                                    <div class="col">
                                        ...
                                        type="text" value="{{$invoice->delivery_date}}">
                                        @error('delivery_date')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                   ...
                                   <div class="row">
                                    <div class="col">
                                        ...
                                        <select name="payment_adjustment" id="payment_adjustment" class="form-control @error('payment_adjustment') is-invalid @enderror">
                                            ...
                                            <option value="30-60-90 payment_days">30-60-90 Payment Days</option>
                                        </select>
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="agent" id="agent" class="form-control @error('agent') is-invalid @enderror">
                                            ...
                                            <option value="{{$admin->id}}" {{$invoice->agent == $admin->id ? 'selected' : ''}}>{{$admin->name}}</option>
                                            @endforeach
                                        </select>
                                            @error('agent')
                                            <span class="text-danger" role="alert">
                                  ...
                                  <br>
                                   ...
                                   <div class="row">
                                    <div class="col">
                                        ...
                                        <select name="bank_account" id="bank_account" class="form-control @error('bank_account') is-invalid @enderror">
                                            ...
                                            <option value="credit_bank" selected>CREDIT BANK</option>
                                    ...
                                    <div class="col">
                                        ...
                                        type="text" value="{{$invoice->email_sent_date}}">
                                    ...
                                    <div class="col">
                                        ...
                                        type="text" value="{{$invoice->comments}}">
                                        @error('comments')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                   ...
                                   <div class="col">
                                        ...
                                        type="text" value="{{$invoice->private_comments}}">
