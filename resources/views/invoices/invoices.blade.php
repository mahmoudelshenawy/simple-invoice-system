                                                                ...
                                                                @can('استعادة الفاتورة')
                                                                    <a class="dropdown-item" href="#" data-invoice_id="{{ $invoice->id }}"
                                                                        data-toggle="modal" data-target="#restore_invoice"><i
                                                                            class="text-warning fas fa-exchange-alt"></i>&nbsp;&nbsp;استعادة الفاتورة</a>
                                                                @endcan
                                                            </div>
                                                    @endif
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    {{-- <form action="{{ url('invoices/2') }}" method="post">        --}}
                        {{ method_field('delete') }}
                        {{ csrf_field() }}
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="/restore_invoice" method="post">
                        @csrf
                </div>
                <div class="modal-body">
           ...
           <!-- تغيير حالة الفاتورة-->
           <div class="modal fade" id="changeInvoiceStatus" tabindex="-1" role="dialog" aria-labelledby="changeInvoiceStatusLabel"
           aria-hidden="true">
           <div class="modal-dialog" role="document">
               <div class="modal-content">
                   <div class="modal-header">
                       <h5 class="modal-title" id="changeInvoiceStatusLabel">تغيير حالة الفاتورة</h5>
                       <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                           <span aria-hidden="true">&times;</span>
                       </button>
                   </div>
                    ...
                    <form action="{{ route('sections.store') }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <input class="fc-datepicker form-control" id="idTourDateDetails" name="Payment_Date" placeholder="YYYY-MM-DD"
                                    type="text" required data-toggle="datepicker">
                            </div>
                        </div><br>
