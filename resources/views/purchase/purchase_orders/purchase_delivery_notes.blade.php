...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">طلبات الشراء</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة مزكرات تسليم الموردين</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
...
@endif
						...
						<div class="card">
							<div class="card-header pb-0">
								...
								<div class="d-flex justify-content-between">
									@can('control_purchase_delivery_notes')
										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													<a href="/purchase_order_data/{{$purchase->id}}" class="btn btn-sm btn-info">
       ...
       <div class="modal-dialog" role="document">
           <div class="modal-content">
               ...
               <form action="/purchase_orders/test" method="post">
                   {{ method_field('delete') }}
                   {{ csrf_field() }}
                   <div class="modal-body">
                       <p>هل انت متاكد من عملية الحذف ؟</p><br>
                       <input type="hidden" name="id" id="purchase_order_id" value="">
                       <input class="form-control" name="purchase_order_name" id="purchase_order_name_delete" type="text" readonly>
                   </div>
...
<script src="{{URL::asset('assets/plugins/select2/js/select2.min.js')}}"></script>
 ...
 <script>
	$('#deleteserviceModal').on('show.bs.modal', function(event) {
		...
		var name = button.data('purchase_order_name')
		var modal = $(this)
		modal.find('.modal-body #purchase_order_id').val(id);
		modal.find('.modal-body #purchase_order_name_delete').val(name);
	})
