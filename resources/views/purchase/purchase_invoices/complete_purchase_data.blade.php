...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> <a href="/purchase_invoices" class="content-title">قائمة الشراءات فواتير</a>
                </h4>
                <span class="content-title"><a href="/choose_items_of_purchase_invoice/{{$purchase->id}}" class=" mt-1 tx-13 mr-2 mb-0">/ إضافة المنتجات للشراء</a></span>
                                ...
                                <div class="panel-body tabs-menu-body main-content-body-right border">
                                        ...
                                        <table class="table table-hover mb-0 text-md-nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   <td>
													<a href="/choose_items_of_purchase_invoice/{{$purchase->id}}" class="btn btn-sm btn-info">
                                  ...
                                  <div class="d-flex justify-content-center my-3">
                                   ...
                                   <div class="tab-pane" id="tab5">
                                          {{-- 1 --}}
                             <form action="{{ route('store_purchase_invoice_data', $purchase->id) }}" method="post" 
                                            autocomplete="off">
                                           @csrf
                                   <div class="row">
                                    <div class="col">
                                        @php
                                        $ref = substr($purchase->reference_number, 4);
                                    @endphp
                                        <label for="inputName" class="control-label">رقم البيع[PINV/Purchase INVOICE]</label>
