        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> <a href="/catalog/services" class="content-title">الخدمات</a>
                    </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/  تفاصيل الخدمه</span>
            </div>
        </div>
                                    ...
                                    <div class="row row-sm ">
                                        <div class=" col-xl-5 col-lg-12 col-md-12">
                                            <div class="preview-pic tab-content">
                                              <div class="tab-pane active" id="pic-1" style="padding: 0 50px;margin-top:30px;"><img src="{{asset($service->imagePath)}}" width="250" height="300" alt="image"/></div>
                                            </div>
                                        </div> 
                                        <!---general descriptions-->
                                        <div class="details col-xl-7 col-lg-12 col-md-12 mt-4 mt-xl-0">
                                            <h4 class="product-title mb-1">{{$service->name}}</h4>
                                            <p class="text-muted tx-13 mb-1">{{$service->reference_number}}</p>
                                            ...
                                            <h6 class="price mr-2">سعر البيع: <span class="h3 ml-3 mb-1">${{$service->sales_price}}</span></h6>
                                            
                                            <p class="product-description mr-2">تفاصيل عن الخدمه:{{$service->description}}.</p>
                                          ...
                                          <div class="card card-statistics">
                                            @can('اضافة مرفق')
                                                <div class="card-body">
                                                    ...
                                                    <form method="post" action="{{ url('/attachment',['service']) }}"
                                            ...
                                            <div class="table-responsive mt-15">
                                                <table class="table center-aligned-table mb-0 table table-hover"
                                                    ...
                                                    <tbody>
                                                        <?php $i = 0; ?>
                                                        @foreach ($service->attachment as $attachment)
                                                            <?php $i++; ?>
                                                            <tr>
                                                                <td>{{ $i }}</td>
                                                                ...
                                                                <td colspan="2">
                                                                    ...
                                                                    <a class="btn btn-outline-success btn-sm"
                                                                        href="{{ url('View_Img') }}/{{ $service->reference_number}}/{{ $attachment->file_name }}/Services"
                                                                        role="button"><i class="fas fa-eye"></i>&nbsp;
                                                                        عرض</a>

                                                                    <a class="btn btn-outline-info btn-sm"
                                                                        href="{{ url('downloadImg') }}/{{ $service->reference_number}}/{{ $attachment->file_name }}/Services"
                                                                        role="button"><i
                                                                    ...
                                                                    @can('حذف المرفق')
                                                                        <button class="btn btn-outline-danger btn-sm"
                                                                            ...
                                                                            data-refernce_number="{{ $service->reference_number }}"
...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <form action="{{ route('delete_pro_attachment',['type' => 'service']) }}" method="post">
