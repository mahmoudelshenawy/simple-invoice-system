        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> <a href="/catalog/services" class="content-title">الخدمات</a>
                    </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تعديل منتج</span>
            </div>
        </div>
                            ...
                            <div class="panel panel-primary tabs-style-2">
                                ...
                                <div class="panel-body tabs-menu-body main-content-body-right border">
                                   ...
                                   <div class="row">
                                       <div class="col">
                                        @php
                                        $ref = substr($service->reference_number, 3);
                                    @endphp
                                       ...
                                       <div class="col">
                                        ...
                                        <input type="text"  name="description" id="" class="form-control form-control-lg" placeholder='' value="{{$service->description}}">
                                        @error('description')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                  ...
                                  <br>
                                   ...
                                   <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="number" class="form-control @error('sales_price') is-invalid @enderror" id="inputName" name="sales_price"
                                            title="يرجي ادخال رقم الخدمه" value="{{$service->sales_price}}">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="number" class="form-control @error('purchase_price') is-invalid @enderror" id="inputName" name="purchase_price"
                                            title="يرجي ادخال رقم الخدمه" value="{{$service->purchase_price}}">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="number" class="form-control @error('discount') is-invalid @enderror" id="inputName" name="discount" value="0.00"
                                            title="يرجي ادخال رقم الخدمه" value="{{$service->discount}}">
                                    ...
                                    <div class="col">
                                        <label for="inputName" class="control-label">TAX(%)</label>
                                            <select name="tax" id="tax" class="form-control @error('tax') is-invalid @enderror">
                                              ...
                                              <option value="5%" {{$service->tax == '5%' ? 'selected' : ''}}>5%</option>
                                              <option value="10%" {{$service->tax == '10%' ? 'selected' : ''}}>10%</option>
                                              <option value="20%" {{$service->tax == '20%' ? 'selected' : ''}}>20%</option>
                                    ...
                                    <div class="tab-pane" id="tab7">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <img src="{{ url($service->imagePath) }}" alt="" width="20" height="20" class="img-fluid">
                                            @endif
                                            </div>
                                          </div>
                                       </div>  
