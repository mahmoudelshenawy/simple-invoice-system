                                ...
                                <div class="panel-body tabs-menu-body main-content-body-right border">
                                   ...
                                   <div class="row">
                                       <div class="col">
                                           ...
                                           @php
                                               $ref = substr($product->reference_number, 3);
                                           @endphp
                                       ...
                                       <div class="col">
                                           ...
                                           <input class="form-control @error('barcode') is-invalid @enderror" name="barcode" placeholder=""
                                               type="number" value="{{$product->barcode}}">
                                               @error('barcode')
                                               <span class="text-danger" role="alert">
                                                   <strong>{{ $message }}</strong>
                                               </span>
                                   ...
                                   <div class="row">
                                       ...
                                       <div class="col">
                                           ...
                                           <input type="text"  name="description" id="" class="form-control form-control-lg" placeholder='' value="{{$product->description}}">
                                           @error('description')
                                           <span class="text-danger" role="alert">
                                               <strong>{{ $message }}</strong>
                                           </span>
                                   ...
                                   <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="number" class="form-control @error('discount') is-invalid @enderror" id="inputName" name="discount" value="0.00"
                                            title="يرجي ادخال رقم المنتج" value="{{$product->discount}}">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="number" class="form-control @error('tax') is-invalid @enderror" id="inputName" name="tax" value="0.00"
                                            title="يرجي ادخال رقم المنتج" value="{{$product->tax}}">
                                 ...
                                 <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="number" class="form-control @error('stock') is-invalid @enderror" id="inputName" name="stock"
                                            title="يرجي ادخال رقم العميل" value="{{$product->stock}}">
                                    ...
                                    <div class="col">
                                        ...
                                        <input class="form-control @error('min_stock') is-invalid @enderror" name="min_stock" placeholder=""
                                            type="number" value="{{$product->min_stock}}">
                                            @error('min_stock')
                                            <span class="text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="tab-pane" id="tab7">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <img src="{{ url($product->imagePath) }}" alt="" width="20" height="20" class="img-fluid">
                                            @endif
                                            </div>
                                          </div>
                                       </div>  
