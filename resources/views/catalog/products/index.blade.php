...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الكتالوج</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة المنتجات</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
...
@endif
						...
						<div class="card">
							<div class="card-header pb-0">
								...
								<div class="d-flex justify-content-between">
									...
									<a href="products/create" class="btn btn-sm btn-primary" style="color:white"><i
									...
									<table class="table key-buttons text-md-nowrap" data-page-length='50'style="text-align: center" id="example1">
										<thead>
											<tr>
												...
												<th class="wd-lg-20p"><span>المنتج</span></th>
												<th class="wd-lg-15p"><span>الاسم</span></th>
												<th class="wd-lg-15p"><span>رقم المنتج</span></th>
												<th class="wd-lg-10p"><span>سعر البيع</span></th>
												<th class="wd-lg-15p"><span>الكمية</span></th>
										...
										<tbody>
											...
											<tr>
												...
												<td>
                                                    <img src="{{ url($product->imagePath) }}" alt="" width="40" height="30" class="img-fluid">
													<br>
												</td>
												<td>
													{{$product->name}}
												...
												<td>
													<a href="/catalog/products/{{$product->id}}" class="btn btn-sm btn-primary">
														<i class="las la-search"></i>
													</a>
													<a href="/catalog/products/{{$product->id}}/edit" class="btn btn-sm btn-info">
       ...
       <div class="modal-dialog" role="document">
           <div class="modal-content">
               ...
               <form action="/catalog/products/destroy" method="post">
                   {{ method_field('delete') }}
                   {{ csrf_field() }}
