        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> <a href="/catalog/products" class="content-title">المنتجات</a>
                    </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/  تفاصيل المنتج</span>
            </div>
        </div>
                                    ...
                                    <div class="row row-sm ">
                                        <div class=" col-xl-5 col-lg-12 col-md-12">
                                            <div class="preview-pic tab-content">
                                              <div class="tab-pane active" id="pic-1" style="padding: 0 50px;margin-top:30px;"><img src="{{asset($product->imagePath)}}" width="250" height="300" alt="image"/></div>
                                            </div>
                                        </div> 
                                        <!---general descriptions-->
                                        <div class="details col-xl-7 col-lg-12 col-md-12 mt-4 mt-xl-0">
                                            <h4 class="product-title mb-1">{{$product->name}}</h4>
                                            <p class="text-muted tx-13 mb-1">{{$product->reference_number}}</p>
                                            ...
                                            <h6 class="price mr-2">سعر البيع: <span class="h3 ml-3 mb-1">${{$product->sales_price}}</span></h6>

                                            <h6 class="price mr-2">الباركود: <span class="h3 ml-3 mb-1">{{$product->barcode}}</span></h6>

                                            <h6 class="mr-2">تصنيف المنتج: <span class="h3 ml-3">{{$product->category->name}}</span></h6>
                                            
                                            <p class="product-description mr-2">تفاصيل عن المنتج:{{$product->description}}.</p>
                                   ...
                                   <div class="tab-pane" id="tab5">
                                    <div class="table-responsive ">
                                        <table class="table key-buttons text-md-nowrap" data-page-length='50'style="text-align: center" id="example1">
                                            <thead>
                                                <tr>
                                                    <th class="wd-lg-20p"><span>سعر الشراء</span></th>
                                                    <th class="wd-lg-15p"><span>سعر البيع</span></th>
                                                    <th class="wd-lg-15p"><span>الكمية المتاحة</span></th>
                                                    <th class="wd-lg-10p"><span>الحد الأدنى للكمية</span></th>
                                                    <th class="wd-lg-15p"><span>الخصم</span></th>
                                                    <th class="wd-lg-15p"><span>الضرائب</span></th>
                                                    <th class="wd-lg-25p">الحد الأدنى للسعر</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                   ...
                                   <!--End Of Tab Two-->
                                    ...
                                    <div class="tab-pane" id="tab7">
                                          ...
                                          <div class="card card-statistics">
                                            @can('control_products')
                                                <div class="card-body">
                                                    <p class="text-danger">* صيغة المرفق pdf, jpeg ,.jpg , png </p>
                                                    <h5 class="card-title">اضافة مرفقات</h5> 
                                                    <form method="post" action="{{ url('/attachment',['product']) }}"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="2">
                                                                    ...
                                                                    <a class="btn btn-outline-success btn-sm"
                                                                        href="{{ url('View_Img') }}/{{ $product->reference_number}}/{{ $attachment->file_name }}/Products"
                                                                        role="button"><i class="fas fa-eye"></i>&nbsp;
                                                                        عرض</a>

                                                                    <a class="btn btn-outline-info btn-sm"
                                                                        href="{{ url('downloadImg') }}/{{ $product->reference_number}}/{{ $attachment->file_name }}/Products"
                                                                        role="button"><i
...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <form action="{{ route('delete_pro_attachment',['type' => 'product']) }}" method="post">
