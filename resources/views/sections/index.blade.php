                            ...
                            <tbody>
                                ...
                                @foreach ($sections as $section)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @can('تعديل قسم')
                                            <a href="#editSectionModal" class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
            ...
            <div class="modal-body">
                ...
                <form action="sections/update" method="post" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="section_name" id="section_name_edit" type="text">
                    </div>
                    <div class="form-group">
...
@section('js')
    ...
    <script>
        $('#editSectionModal').on('show.bs.modal', function(event) {
            ...
            modal.find('.modal-body #section_name_edit').val(section_name);
