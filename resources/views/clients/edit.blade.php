        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> <a href="/clients" class="content-title">العملاء</a>
                    </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تعديل بيانات عميل</span>
            </div>
        </div>
                            ...
                            <div class="panel panel-primary tabs-style-2">
                                ...
                                <div class="panel-body tabs-menu-body main-content-body-right border">
                                   ...
                                   <div class="row">
                                       <div class="col">
                                        @php
                                        $ref = substr($client->reference_number, 3);
                                      @endphp
                                       ...
                                       <div class="col">
                                           ...
                                           <input class="form-control @error('legal_name') is-invalid @enderror" name="legal_name" placeholder=""
                                               type="text" value="{{ $client->legal_name }}">
                                               @error('legal_name')
                                               <span class="text-danger" role="alert">
                                                   <strong>{{ $message }}</strong>
                                               </span>
                                   ...
                                   <div class="row">
                                       <div class="col">
                                           ...
                                           <input type="text" class="form-control @error('tin') is-invalid @enderror" id="tin" name="tin" value="{{ $client->tin }}">
                                           @error('tin')
                                           <span class="text-danger" role="alert">
                                               <strong>{{ $message }}</strong>
                                           </span>
                                   ...
                                   <div class="row">
                                       <div class="col">
                                           ...
                                           <input type="text" class="form-control @error('fax') is-invalid @enderror" id="fax" name="fax" value="{{ $client->fax }}">
                                           @error('fax')
                                           <span class="text-danger" role="alert">
                                               <strong>{{ $message }}</strong>
                                           </span>
                                   ...
                                   <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="number" class="form-control @error('discount') is-invalid @enderror" id="inputName" name="discount" value="0.00"
                                            title="يرجي ادخال رقم العميل" value="{{ $client->disount }}">
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="payment_option" id="payment_option" class="form-control @error('payment_option') is-invalid @enderror">
                                            ...
                                            <option value="bank_transfer" {{ $client->payment_option == 'bank_transfer' ? 'selected' : '' }}>Bank Transfer</option>
                                            <option value="direct_debit" {{ $client->payment_option == 'direct_debit' ? 'selected' : '' }}>direct Debit</option>
                                            <option value="check" {{ $client->payment_option == 'check' ? 'selected' : '' }}>Check</option>
                                            <option value="cash" {{ $client->payment_option == 'cash' ? 'selected' : '' }}>Cash</option>
                                        </select>
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="agent" id="agent" class="form-control @error('agent') is-invalid @enderror">
                                            ...
                                            <option value="{{$admin->id}}" {{ $client->agent == $admin->id ? 'selected' : '' }}>{{$admin->name}}</option>
                                            @endforeach
                                        </select>
                                            @error('agent')
                                            <span class="text-danger" role="alert">
                                   ...
                                   <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="payment_terms" id="payment_terms" class="form-control @error('payment_terms') is-invalid @enderror">
                                            ...
                                            <option value="immediate_payment" {{ $client->payment_terms == 'immediate_payment' ? 'selected' : '' }}>الدفع فورى</option>
                                            <option value="30-60-90 Days Payment" {{ $client->payment_terms == '30-60-90 Days Payment' ? 'selected' : '' }}>دفع بالتقسيط جزئي</option>
                                        </select>
                                            @error('payment_terms')
                                            <span class="text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="payment_adjustment" id="payment_adjustment" class="form-control @error('payment_adjustment') is-invalid @enderror">
                                            ...
                                            <option value="previous_than" {{ $client->payment_adjustment == 'previous_than' ? 'selected' : '' }}>قبل الموعد</option>
                                            <option value="later_than" {{ $client->payment_adjustment == 'later_than' ? 'selected' : '' }}>متأخر عن الموعد</option>
                                            <option value="closest_to" {{ $client->payment_adjustment == 'closest_to' ? 'selected' : '' }}>قريب من الموعد</option>
                                        </select>
                                   ...
                                   <div class="row">
                                    <div class="col">
                                        ...
                                        <select name="currency" id="currency" class="form-control @error('currency') is-invalid @enderror select2">
                                            ...
                                            <option value="{{$key}}-{{$val}}" {{ $client->currency == $key .'-'. $val ? 'selected' : '' }}>{{$key}}-{{$val}}</option>
                                            @endforeach
                                        </select>
                                            @error('currency')
                                            <span class="text-danger" role="alert">
                                 ...
                                 <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control @error('bank_account') is-invalid @enderror" id="inputName" name="bank_account"
                                            title="يرجي ادخال رقم العميل" value="{{$client->bank_account}}">
                                    ...
                                    <div class="col">
                                        ...
                                        <input class="form-control @error('bank_name') is-invalid @enderror" name="bank_name" placeholder=""
                                            type="text" value="{{$client->bank_name}}">
                                            @error('bank_name')
                                            <span class="text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
