					...
					<div class="main-header-right">
								...
								<div class="dropdown  nav-itemd-none d-md-flex">
									<a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
										<span class="avatar country-Flag mr-0 align-self-center bg-transparent">
											<img src="{{URL::asset('assets/img/flags/egy.png')}}" alt="img"></span>
										<div class="my-auto">
						...
						{{-- @endcan --}}
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset(auth()->user()->profile->avatar ?? 'Images/default.jpg')}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="{{URL::asset(auth()->user()->profile->avatar ?? 'Images/default.jpg')}}" class=""></div>
											<div class="mr-3 my-auto">
												<h6>{{auth()->user()->name}}</h6><span>Administrator</span>
											</div>
										</div>
									</div>
